...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'aula_chamadas'
      AND policyname = 'Admins full access aula_chamadas'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'aula_chamadas'
      AND policyname = 'Mestre manage own CT aula_chamadas'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'aula_chamadas'
      AND policyname = 'Aluno can read own CT aula_chamadas'
  ) THEN
